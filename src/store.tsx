...
export const PIN_PRODUCTS: Product[] = [
  { id: 'p1', name: 'Summit Seeker Pin', category: 'Pins', price: 4.99, image: PIN_IMAGES[0], rating: 4.9, reviewCount: 312, badge: 'Best Seller', description: 'Hard enamel mountain peak pin with gold plating. Perfect for your backpack, jacket, or hat.', stock: 156, isPin: true, specs: [{ label: 'Material', value: 'Hard enamel' }, { label: 'Size', value: '1.25" (32mm)' }, { label: 'Backing', value: 'Butterfly clutch' }, { label: 'Plating', value: 'Gold' }], createdAt: '2026-01-15' },
  { id: 'p2', name: 'Midnight Campfire Pin', category: 'Pins', price: 4.99, image: PIN_IMAGES[1], rating: 4.8, reviewCount: 267, description: 'Glow-in-the-dark campfire scene surrounded by pine trees under a starry sky.', stock: 134, isPin: true, specs: [{ label: 'Material', value: 'Hard enamel' }, { label: 'Size', value: '1.1" (28mm)' }, { label: 'Special', value: 'Glow in the dark' }, { label: 'Plating', value: 'Gold' }], createdAt: '2026-01-20' },
  ...
  { id: 'p5', name: 'Starry Night Camper Pin', category: 'Pins', price: 4.99, image: PIN_IMAGES[4], rating: 4.8, reviewCount: 189, badge: 'New', description: 'Cozy tent under a swirling starry sky with crescent moon. For the night campers.', stock: 156, isPin: true, specs: [{ label: 'Material', value: 'Hard enamel' }, { label: 'Size', value: '1.1" (28mm)' }, { label: 'Backing', value: 'Butterfly clutch' }, { label: 'Plating', value: 'Gold' }], createdAt: '2026-04-01' },
  { id: 'p6', name: 'Trail Boot Pin', category: 'Pins', price: 4.99, image: PIN_IMAGES[5], rating: 4.6, reviewCount: 156, description: 'Detailed hiking boot with mountain landscape reflected in the leather.', stock: 98, isPin: true, specs: [{ label: 'Material', value: 'Hard enamel' }, { label: 'Size', value: '1.25" (32mm)' }, { label: 'Backing', value: 'Butterfly clutch' }, { label: 'Plating', value: 'Gold' }], createdAt: '2026-01-10' },
  ...
  { id: 'p14', name: 'Sunset Ridge Pin', category: 'Pins', price: 4.99, image: PIN_IMAGES[5], rating: 4.9, reviewCount: 234, badge: 'Best Seller', description: 'Golden sunset behind layered mountain ridges in warm orange and teal.', stock: 178, isPin: true, specs: [{ label: 'Material', value: 'Hard enamel' }, { label: 'Size', value: '1.3" (33mm)' }, { label: 'Backing', value: 'Butterfly clutch' }, { label: 'Plating', value: 'Gold' }], createdAt: '2026-01-12' },
  { id: 'p15', name: 'Forest Owl Pin', category: 'Pins', price: 4.99, image: PIN_IMAGES[6], rating: 4.6, reviewCount: 89, description: 'Wise owl perched on a branch with detailed feather patterns in teal.', stock: 95, isPin: true, specs: [{ label: 'Material', value: 'Hard enamel' }, { label: 'Size', value: '1.1" (28mm)' }, { label: 'Backing', value: 'Butterfly clutch' }, { label: 'Plating', value: 'Gold' }], createdAt: '2026-03-01' },
  { id: 'p16', name: 'Go Wild Logo Pin', category: 'Pins', price: 4.99, image: PIN_IMAGES[7], rating: 4.7, reviewCount: 145, badge: 'Official', description: 'The official GoWild mountain and sun logo pin. Show your wild side.', stock: 234, isPin: true, specs: [{ label: 'Material', value: 'Hard enamel' }, { label: 'Size', value: '1.0" (25mm)' }, { label: 'Backing', value: 'Butterfly clutch' }, { label: 'Plating', value: 'Gold' }], createdAt: '2026-01-01' },
  { id: 'p17', name: 'Topo Map Pin', category: 'Pins', price: 4.99, image: PIN_IMAGES[0], rating: 4.5, reviewCount: 67, description: 'Topographic contour lines forming a mountain shape. For the map lovers.', stock: 78, isPin: true, specs: [{ label: 'Material', value: 'Soft enamel' }, { label: 'Size', value: '1.2" (30mm)' }, { label: 'Backing', value: 'Butterfly clutch' }, { label: 'Plating', value: 'Black nickel' }], createdAt: '2026-03-10' },
  { id: 'p18', name: 'Hot Cocoa Camper Pin', category: 'Pins', price: 4.99, image: PIN_IMAGES[1], rating: 4.8, reviewCount: 189, badge: 'New', description: 'Cozy campfire scene with a mug of hot cocoa and marshmallows roasting.', stock: 134, isPin: true, specs: [{ label: 'Material', value: 'Hard enamel' }, { label: 'Size', value: '1.1" (28mm)' }, { label: 'Backing', value: 'Butterfly clutch' }, { label: 'Plating', value: 'Gold' }], createdAt: '2026-04-15' },
  { id: 'p19', name: 'Eagle Peak Pin', category: 'Pins', price: 4.99, image: PIN_IMAGES[2], rating: 4.7, reviewCount: 112, description: 'Bald eagle soaring over a mountain peak with spread wings in gold detail.', stock: 87, isPin: true, specs: [{ label: 'Material', value: 'Hard enamel' }, { label: 'Size', value: '1.3" (33mm)' }, { label: 'Backing', value: 'Butterfly clutch' }, { label: 'Plating', value: 'Gold' }], createdAt: '2026-03-15' },
  { id: 'p20', name: 'Trail Marker Pin', category: 'Pins', price: 4.99, image: PIN_IMAGES[3], rating: 4.6, reviewCount: 94, description: 'Classic trail blaze marker design for hikers who follow the path less traveled.', stock: 156, isPin: true, specs: [{ label: 'Material', value: 'Hard enamel' }, { label: 'Size', value: '1.0" (25mm)' }, { label: 'Backing', value: 'Butterfly clutch' }, { label: 'Plating', value: 'Gold' }], createdAt: '2026-03-20' },
];

export const STICKER_PRODUCTS: Product[] = [
  { id: 's1', name: 'Mountain Vibes Sticker Pack', category: 'Stickers', price: 12.99, image: '/stickers-pack.jpg', rating: 4.9, reviewCount: 456, badge: '50 Stickers', description: '50 waterproof vinyl stickers featuring mountains, trails, summits, and peak badges.', stock: 234, isBundle: true, bundleSize: 50, specs: [{ label: 'Quantity', value: '50 stickers' }, { label: 'Material', value: 'Waterproof vinyl' }, { label: 'Size Range', value: '1.5" - 3"' }, { label: 'Finish', value: 'Matte' }, { label: 'Durability', value: '5+ years outdoor' }], createdAt: '2026-01-08' },
  { id: 's2', name: 'Wildlife Sticker Pack', category: 'Stickers', price: 12.99, image: '/stickers-pack.jpg', rating: 4.8, reviewCount: 378, badge: '50 Stickers', description: '50 waterproof vinyl stickers featuring bears, wolves, eagles, deer, and forest animals.', stock: 198, isBundle: true, bundleSize: 50, specs: [{ label: 'Quantity', value: '50 stickers' }, { label: 'Material', value: 'Waterproof vinyl' }, { label: 'Size Range', value: '1.5" - 3"' }, { label: 'Finish', value: 'Glossy + holographic' }, { label: 'Durability', value: '5+ years outdoor' }], createdAt: '2026-01-18' },
...
const DEFAULT_REVIEWS: Review[] = [
  // Pin reviews
  { id: 'r1', productId: 'p1', productName: 'Summit Seeker Pin', userName: 'Sarah M.', date: '2026-03-15', rating: 5, text: 'Absolutely love this pin! The gold plating is gorgeous and the detail is incredible. Already got compliments on my backpack.' },
  { id: 'r2', productId: 'p1', productName: 'Summit Seeker Pin', userName: 'Jake T.', date: '2026-03-10', rating: 4, text: 'Really nice quality. The hard enamel feels premium. Would love to see a bigger size option though.' },
  { id: 'r3', productId: 'p1', productName: 'Summit Seeker Pin', userName: 'Emily R.', date: '2026-02-28', rating: 5, text: 'Best enamel pin I own. The butterfly clutch is secure and the colors are vibrant. Buying more for gifts!' },
  { id: 'r4', productId: 'p14', productName: 'Sunset Ridge Pin', userName: 'Mike H.', date: '2026-04-01', rating: 5, text: 'The sunset colors on this pin are stunning. The orange and teal combo is perfect. My favorite pin so far.' },
  { id: 'r5', productId: 'p14', productName: 'Sunset Ridge Pin', userName: 'Lisa K.', date: '2026-03-22', rating: 5, text: 'Bought 3 pins for the bundle deal. This one is my favorite. The gold plating really makes it pop.' },
  // Sticker reviews
  { id: 'r6', productId: 's1', productName: 'Mountain Vibes Sticker Pack', userName: 'Alex P.', date: '2026-04-05', rating: 5, text: '50 unique stickers and every single one is amazing quality. The waterproof vinyl held up through rain and sun on my water bottle.' },
  { id: 'r7', productId: 's1', productName: 'Mountain Vibes Sticker Pack', userName: 'Dana W.', date: '2026-03-18', rating: 5, text: 'These stickers are incredible. Put them on my car and they have not peeled at all after 2 months. Will buy again!' },
  { id: 'r8', productId: 's5', productName: 'Holographic Outdoor Sticker Pack', userName: 'Chris B.', date: '2026-04-02', rating: 5, text: 'The holographic effect is even better in person. The rainbow shimmer catches the light beautifully. Worth every penny.' },
  // Neck Warmer reviews
  { id: 'r9', productId: 'n1', productName: 'Alpine Frost Neck Warmer', userName: 'Tom R.', date: '2026-03-25', rating: 4, text: 'Kept me warm on a 5F hike. The fleece is soft and does not itch. Great for the price point.' },
  { id: 'r10', productId: 'n1', productName: 'Alpine Frost Neck Warmer', userName: 'Anna S.', date: '2026-03-12', rating: 5, text: 'Love the mountain print! Got one for myself and one as a gift. Perfect for skiing and cold morning hikes.' },
  { id: 'r11', productId: 'n8', productName: 'Merino Wool Neck Warmer', userName: 'Ryan G.', date: '2026-04-08', rating: 5, text: 'The merino wool is a game changer. No odor even after a full day of hiking. Temperature regulating is real.' },
  // Picnic Mat reviews
  { id: 'r12', productId: 'mat1', productName: 'GoWild Waterproof Picnic Mat', userName: 'Jenny L.', date: '2026-03-30', rating: 5, text: 'Used this at the beach and it was perfect. The waterproof bottom kept us dry even on wet sand. Folds up so small too!' },
  { id: 'r13', productId: 'mat1', productName: 'GoWild Waterproof Picnic Mat', userName: 'David M.', date: '2026-03-15', rating: 4, text: 'Great mat for the price. The fleece top is comfortable and the PEVA bottom works well. Wish it came in more sizes.' },
  // Accessory reviews
  { id: 'r14', productId: 'a1', productName: 'Titanium Multi-Tool Spork', userName: 'Pat K.', date: '2026-04-10', rating: 5, text: 'Only 18g and it replaces 3 utensils plus a bottle opener. Used it on a 5-day backpacking trip. Indispensable.' },
  { id: 'r15', productId: 'a2', productName: 'LED Emergency Camp Lamp', userName: 'Sam W.', date: '2026-04-01', rating: 5, text: '300 lumens is brighter than expected. The SOS mode is a nice safety touch. Battery lasted 10 hours on low.' },
  { id: 'r16', productId: 'a2', productName: 'LED Emergency Camp Lamp', userName: 'Nina J.', date: '2026-03-20', rating: 4, text: 'Solid lamp. USB-C charging is fast. Only wish it had a warmer light temperature. Otherwise perfect.' },
  { id: 'r17', productId: 'p5', productName: 'Starry Night Camper Pin', userName: 'HikerJoe', date: '2026-04-20', rating: 5, text: 'The glow in the dark feature is subtle but awesome. Great addition to my camping pin collection.' },
  { id: 'r18', productId: 'p8', productName: 'Mountain Buck Pin', userName: 'ArtLover', date: '2026-04-18', rating: 5, text: 'The antler detail is incredible. You can see the tiny mountain motifs. Best quality pin I have ever purchased.' },
];
...
export function StoreProvider({ children }: { children: ReactNode }) {
  const [cart, setCart] = useState<CartItem[]>(() => {
    ...
    return saved.length > 0 ? saved : [
      { product: PIN_PRODUCTS[0], quantity: 2, color: 'Gold' },
      { product: NECK_WARMER_PRODUCTS[0], quantity: 1, color: 'Mountain Blue', size: 'One Size' },
      { product: ACCESSORY_PRODUCTS[0], quantity: 1 },
    ];
  });
  ...
  const [orders] = useState<Order[]>([
    {
      ...
      items: [{ product: PIN_PRODUCTS[1], quantity: 3, bundlePrice: 10 }, { product: STICKER_PRODUCTS[0], quantity: 1 }],
      total: 22.99, status: 'delivered',
      shippingAddress: '123 Mountain Ridge Rd, Boulder, CO 80301',
    },
    {
      id: 'GW-2026-8840', date: '2026-04-22',
      items: [{ product: PICNIC_MAT_PRODUCT, quantity: 1, color: 'Red' }],
      total: 34.99, status: 'shipped',
      shippingAddress: '123 Mountain Ridge Rd, Boulder, CO 80301',
    },
    {
      id: 'GW-2026-8841', date: '2026-04-25',
      items: [{ product: PIN_PRODUCTS[0], quantity: 6, bundlePrice: 20 }, { product: ACCESSORY_PRODUCTS[1], quantity: 1 }],
  ...
  // Auto-bundle: pins in cart are automatically grouped into 3/$10 bundles
  const { cartTotal, cartSavings } = useMemo(() => {
    // Separate pins from non-pins
    const pinItems = cart.filter(i => i.product.isPin);
    const nonPinItems = cart.filter(i => !i.product.isPin);

    // Non-pin total (regular pricing)
    const nonPinTotal = nonPinItems.reduce((sum, i) => sum + (i.bundlePrice ?? i.product.price) * i.quantity, 0);

    // Count total pins in cart (each quantity counts)
    const totalPinQty = pinItems.reduce((sum, i) => sum + i.quantity, 0);

    if (totalPinQty === 0) {
      return { cartTotal: nonPinTotal, cartSavings: 0 };
    }

    // Apply bundle pricing to pins
    const bundleCalc = calculateBundlePrice(totalPinQty);

    return {
      cartTotal: nonPinTotal + bundleCalc.bundlePrice,
      cartSavings: bundleCalc.savings,
    };
  }, [cart]);
  ...
  return (
    <StoreContext.Provider
      value={{ cart, wishlist, orders, reviews, addToCart, addMultipleToCart, removeFromCart, updateQuantity, toggleWishlist, isInWishlist, moveWishlistToCart, clearCart, addOrder, addReview, getProductReviews, cartCount, cartTotal, cartSavings, wishlistCount, cartDrawerOpen, setCartDrawerOpen }}
    >
      {children}
    </StoreContext.Provider>
  );
